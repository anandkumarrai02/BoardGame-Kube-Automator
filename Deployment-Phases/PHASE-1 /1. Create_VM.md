...
9. **Configure Security Group**:
   ...
   - You may also want to allow other ports based on your requirements (e.g., HTTP, HTTPS) as in this pic ![Alt text](https://github.com/anandkumarrai02/BoardGame-Kube-Automator/blob/main/Deployment-Phases/Img/Screenshot%202024-03-13%20002123.png)
